...
export const PERMISSIONS = {
  ...
  /** Expense claims — HR and Super Admin approve; line managers handled in the API */
  reviewExpenses: ["SUPER_ADMIN", "HR_ADMIN"] as UserRole[],
  /** Mark approved claims paid — Finance portal only */
  reimburseExpenses: ["FINANCE"] as UserRole[],
